          ...
          <div class="col-md-12">            
            <div class="card">
              <div class="card-header">
                <h5 class="card-title">DATA POTONGAN PERIODE <b><?php echo $this->session->userdata('ses_tunjangan_nm_periode');?></b></h5>
                  ...
                  <tbody>
                    ...
                    <div class="modal fade" id="ubah-info-<?php echo $ad->ID_Tunjangan;?>">
                      <div class="modal-dialog">
                        <form action="<?php echo base_url() ?>Tunjangan/update_potongan" method="post">
                    ...
                    <div class="modal fade" id="hapus-info-<?php echo $ad->ID_Tunjangan;?>">
                      <div class="modal-dialog">
                        <form action="<?php echo base_url() ?>Tunjangan/hapus_potongan" method="post">
                        <div class="modal-content">
...
<!-- modal tambah -->
  ...
  <div class="modal fade" id="modal-default">
    <div class="modal-dialog">
      <form action="<?php echo base_url() ?>Tunjangan/simpan_potongan" method="post">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <input type="text" name="jenis" value="1" hidden>
