...
<body>
   <div class="page">
        ...
        <div class="lineinvoice">
            <div>
                <h2>LAPORAN REKAP LEMBUR KARYAWAN</h2>
            </div>
        </div>
            ...
            <table class="table table-striped table-bordered" cellpadding="2" cellspacing="0" style="">
                <thead>
                    <tr style="background:#dadade;">
                        ...
                        <th style="padding: 5px; border: 1px solid black; text-align: center;">Lembur/Jam</th>
                        <th style="padding: 5px; border: 1px solid black; text-align: center;">Status</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;"><?php echo $ad->KalkulasiLembur;?> Jam</td>
                        <?php if ($ad->ValidasiLembur == 0): ?>
                          <td style="background-color:red;color: white;text-align: center;">Tidak DiSetujui</td>
                        <?php else: ?>
                          <td style="background-color:green;color: white;text-align: center;">DiSetujui</td>
                        <?php endif ?>
