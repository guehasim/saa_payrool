...
<body>
   <div class="page">
        ...
        <div class="lineinvoice">
            <div>
                <h2>LAPORAN ABSENSI FINGER KARYAWAN</h2>
            </div>
        </div>
            ...
            <table class="table table-striped table-bordered" cellpadding="2" cellspacing="0" style="">
                <thead>
                    <tr style="background:#dadade;">
                        ...
                        <th style="padding: 5px; border: 1px solid black; text-align: center;">Jam</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;"><?php echo date('d M y',strtotime($ad->Tanggal)) ;?></td>
                        <td style="text-align:center;"><?php echo substr($ad->Jam,11,8) ;?></td>
